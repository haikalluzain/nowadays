                    ...
                    <template v-else>   
                        ...
                        <div class="activity" v-for="(today, index) in filtered" :key="today.id">
                            ...
                            <div class="activity-detail shadow-sm">
                                <template>
                                    <div class="mb-2">
                                        <span class="font-weight-bold text-primary h6">{{ today.start + ' - ' + today.end }}</span>
                                ...
                                <form @submit.prevent="update" v-show="show_edit == index">
                                    <div class="form-group mb-2">
                                        ...
                                        <textarea class="form-control" v-model="edit.activity" required="" autofocus=""></textarea>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="ml-2">
                                                <a href="#" class="btn btn-icon btn-danger" @click="show_edit = -1"><i class="fas fa-times"></i></a>
                                                <button type="submit" class="btn btn-icon btn-success" @click.prevent="update"><i class="fas fa-check"></i></button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <form @submit.prevent="add">
                                <div class="form-group row mb-0">
                                    <div class="col-md-6">
                                        ...
                                        <textarea class="form-control" v-model="today.activity" required="" autofocus=""></textarea>
                                    </div>
