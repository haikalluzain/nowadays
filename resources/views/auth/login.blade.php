...
@section('content')
<div class="w-100 h-100 bg-primary position-fixed">
    <div class="row justify-content-center h-100 align-items-center">
        <div class="col-10 col-sm-8 col-md-5 col-lg-4 col-xl-3">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" name="remember" id="remember"
                                    {{ old('remember') ? 'checked' : '' }} checked class="custom-control-input"
            ...
            <div class="text-white text-center">
                Don't have an account? <a class="text-white font-weight-bold" href="{{ route('register') }}">Create
                    One</a>
            </div>
        </div>
    </div>
