                  		...
                  		<div class="card-body">
                    		<form action="{{ route('thumbnail.store') }}" method="post" enctype="multipart/form-data">
			                    ...
			                    <div class="form-group row mb-4">
			                      	...
			                      	<div class="col-sm-12 col-md-7">
			                          	<input type="file" class="dropify" name="image"data-allowed-file-extensions="jpg jpeg png" data-max-file-size="4m" data-show-remove="false" required id="image" data-validation-required-message="Silahkan pilih gambar produk">
			                      	</div>
			                    </div>
